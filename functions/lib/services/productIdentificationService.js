...
exports.productIdentificationService = void 0;
...
class ProductIdentificationService {
     ...
     */
    async identifyProducts(message, menu) {
        try {
      ...
      `;
            ...
            // Validação básica
            if (!result.identifiedProducts)
                result.identifiedProducts = [];
            if (!result.ambiguousProducts)
                result.ambiguousProducts = [];
...
exports.productIdentificationService = new ProductIdentificationService();
