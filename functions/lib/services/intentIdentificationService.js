...
exports.intentIdentificationService = void 0;
...
class IntentIdentificationService {
     ...
     */
    async identifyIntention(message, cartItems) {
        try {
            const prompt = `
...
exports.intentIdentificationService = new IntentIdentificationService();
