...
exports.parseGooglePlacesAddress = parseGooglePlacesAddress;
 ...
 */
function parseGooglePlacesAddress(addressComponents) {
    const getComponent = (type) => addressComponents.find((component) => component.types.includes(type))?.long_name || '';
    return {
