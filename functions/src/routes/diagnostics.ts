...
router.get('/health', async (req, res) => {
  try {
    ...
    diagnostics.info('Relatório de saúde solicitado', {
    ...
    diagnostics.error('Erro ao gerar relatório de saúde', error, {
      category: DiagnosticCategory.PERFORMANCE,
...
router.get('/dashboard', (req, res) => {
  diagnostics.info('Dashboard de diagnósticos acessado', {
    category: DiagnosticCategory.PERFORMANCE,
...
router.post('/test-error', (req, res) => {
  ...
  diagnostics.warn('Teste de erro solicitado', {
    category: DiagnosticCategory.PERFORMANCE,
  ...
  try {
    if (level === 'critical') {
      diagnostics.critical(message, new Error('Erro de teste crítico'), {
        category: DiagnosticCategory.PERFORMANCE,
        action: 'test_critical_error'
      });
    } else if (level === 'error') {
      diagnostics.error(message, new Error('Erro de teste'), {
        category: DiagnosticCategory.PERFORMANCE,
        action: 'test_error'
      });
    } else if (level === 'warn') {
