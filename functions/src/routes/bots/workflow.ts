 ...
 */
const moveOrderToNextFlow = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    const success = await workflowService.moveOrderToNextFlow({
      orderId,
      fromFlowId,
      toFlowId,
      minutes,
...
const cancelOrder = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    const success = await workflowService.cancelOrder(
      orderId,
...
const getOrderStatus = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    const status = await workflowService.getOrderStatus(orderId);
 ...
 */
const sendOrderProduction = async (req: Request, res: Response): Promise<void> => {
  try {
...
const sendOrderDeliveryRoute = async (req: Request, res: Response): Promise<void> => {
  try {
    const { orderId, storeId } = req.body;
...
const sendOrderDelivered = async (req: Request, res: Response): Promise<void> => {
  try {
    const { orderId, storeId } = req.body;
